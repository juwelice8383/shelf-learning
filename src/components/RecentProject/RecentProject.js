...
import recentimg from '../../asset/images/RecentProject.png'
                    ...
                    <Row>
                            <Col className="d-flex align-items-stretch" lg={4} md={6} sm={12}>
                                <Card className='RecentProjectCards mb-3' style={{ width: '22rem' }}>
                                    ...
                                    <Card.Body>
                                        <Card.Title className='FirstCardTittle text-center'>Card Title</Card.Title>
                            ...
                            <Col className="d-flex align-items-stretch" lg={4} md={6} sm={12}>
                                <Card className='RecentProjectCards mb-3' style={{ width: '22rem' }}>
                                    <Card.Img variant="top" src={recentimg} />
                                    <Card.Body>
                                        <Card.Title className='SecondCardTittle text-center'>Card Title</Card.Title>
                            ...
                            <Col className="d-flex align-items-stretch" lg={4} md={6} sm={12}>
                                <Card className='RecentProjectCards mb-3' style={{ width: '22rem' }}>
                                    <Card.Img variant="top" src={recentimg} />
                                    <Card.Body>
                                        <Card.Title className='ThirdCardTittle text-center'>Card Title</Card.Title>
